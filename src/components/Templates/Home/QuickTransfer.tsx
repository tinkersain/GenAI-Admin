  ...
  return (
    <Card className="p-8 bg-white dark:bg-black dark:text-white rounded-4xl shadow-none space-y-5 flex flex-col justify-between">
      <div className="flex items-center justify-between">
        <h3 className="text-3xl 2xl:text-2xl">{t("Most Active Users")}</h3>
        {/* <Link
      ...
      <div className="flex items-center justify-between gap-2 bg-[#F3F4F7] dark:bg-[#373737] py-3.5 px-[22px] rounded-full">
        <div className="flex items-center gap-2">
          <Image
            src="https://img.icons8.com/?size=100&id=8M51Apn3XQEy&format=png&color=000000"
            className="size-10"
            radius="full"
          />
          <span className="text-xl font-poppinsRegular">85 Users</span>
        </div>
